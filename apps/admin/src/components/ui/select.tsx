...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between whitespace-nowrap rounded-[5px] border border-input bg-transparent px-3 py-2 text-sm tracking-[-0.05em] ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:bg-gray-50 disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
