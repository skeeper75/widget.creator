...
CREATE TABLE "products" (
	...
	"huni_code" varchar(10),
	"legacy_huni_id" varchar(50),
	"excel_mes_code" varchar(50),
...
CREATE TABLE "option_choices" (
	...
	"image_alt_ko" varchar(200),
	"swatch_color" varchar(7),
	"swatch_gradient" varchar(200),
	"badge_type" varchar(20),
	"badge_text_ko" varchar(30),
	"sublabel_ko" varchar(100),
	"price_delta_text" varchar(30),
	"is_premium" boolean DEFAULT false,
	"tooltip_ko" varchar(300),
	"guide_image_url" varchar(500),
	"guide_title_ko" varchar(100),
	"guide_body_ko" text,
	"guide_popup_position" varchar(20) DEFAULT 'right',
	"guide_popup_width" integer,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE "option_definitions" (
	...
	"tooltip_ko" varchar(500),
	"unit_ko" varchar(20),
	"help_text_ko" varchar(300),
	"label_icon" varchar(50),
	"layout_width" varchar(10) DEFAULT 'full',
	"chip_columns" varchar(5) DEFAULT 'auto',
...
CREATE TABLE "product_options" (
	...
	"is_active" boolean DEFAULT true NOT NULL,
	"label_override_ko" varchar(100),
	"tooltip_override_ko" varchar(500),
	"layout_width_override" varchar(10),
	"min_value" integer,
	"max_value" integer,
	"step_value" integer,
	"collapsed_default" boolean,
	"choice_filter" varchar(500),
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
...
ALTER TABLE "option_constraints" ADD CONSTRAINT "option_constraints_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "option_dependencies" ADD CONSTRAINT "option_dependencies_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "data_import_log_status_idx" ON "data_import_log" USING btree ("status");--> statement-breakpoint
...
CREATE UNIQUE INDEX "product_mes_mapping_regular_uidx" ON "product_mes_mapping" USING btree ("product_id","mes_item_id") WHERE "product_mes_mapping"."cover_type" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "product_mes_mapping_cover_uidx" ON "product_mes_mapping" USING btree ("product_id","mes_item_id","cover_type") WHERE "product_mes_mapping"."cover_type" IS NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "paper_product_mapping_regular_uidx" ON "paper_product_mapping" USING btree ("paper_id","product_id") WHERE "paper_product_mapping"."cover_type" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "paper_product_mapping_cover_uidx" ON "paper_product_mapping" USING btree ("paper_id","product_id","cover_type") WHERE "paper_product_mapping"."cover_type" IS NOT NULL;--> statement-breakpoint
...
CREATE INDEX "widgets_status_idx" ON "widgets" USING btree ("status");