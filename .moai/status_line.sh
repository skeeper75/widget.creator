...
if [ -f "/home/innojini/go/bin/moai" ]; then
	exec "/home/innojini/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/home/innojini/.local/bin/moai" ]; then
	exec "/home/innojini/.local/bin/moai" statusline < "$temp_file"
fi
